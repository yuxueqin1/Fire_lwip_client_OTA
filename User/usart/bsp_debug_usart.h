...
//引脚定义
/*******************************************************/
#define DEBUG_USART                             USART2 //UART8
...
#define DEBUG_USART_DE_GPIO_PORT                GPIOD
#define DEBUG_USART_DE_GPIO_CLK_ENABLE()        __GPIOD_CLK_ENABLE()
#define DEBUG_USART_DE_PIN                      GPIO_PIN_11
